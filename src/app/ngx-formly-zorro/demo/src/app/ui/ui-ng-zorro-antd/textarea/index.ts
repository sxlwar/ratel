...
const NzAutosizeFieldConfig: FormlyFieldConfig[] = [
    {
        ...
        templateOptions: {
            label: 'nzAutosize',
            options: [
                { value: NzAutosizeValue.false, label: 'false' },
                { value: NzAutosizeValue.true, label: 'true' },
                { value: NzAutosizeValue.useObject, label: 'config' },
            ],
        },
    },
    {
...
const TextareaExampleConfig: NzDebugConfig = {
    debugFields: [
        ...debugFields,
        {
            ...
            fieldGroup: [NzSizeFieldConfig, ...NzAutosizeFieldConfig],
        },
    ],
